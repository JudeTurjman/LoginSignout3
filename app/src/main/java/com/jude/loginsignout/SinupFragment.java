 ...
 * Use the {@link SinupFragment#newInstance} factory method to
...
public class SinupFragment extends Fragment {
     ...
     * @return A new instance of fragment SinupFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SinupFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sinup, container, false);
    }

    @Override
    public void onStart() {
        super.onStart();
        fbs = FiarbaseS.getInstance();
                ...
                fbs.getAuth().createUserWithEmailAndPassword(Username, Password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(getActivity(), "failed to Signing up !", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
